...
//Output all elements from the stack
...
//Counting all elements in a stack
...
int main(){
    ...
    do
    {
        ...
        cout<<"\n2. Remove an element from the front of the stack";//
        cout<<"\n3. Output all elements from the stack";//
        cout<<"\n4. Counting all elements in a stack";//
